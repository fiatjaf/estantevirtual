...
var _user$project$App$updateURL = function (searches) {
...
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {searches: a, selected: b, apiURL: c};
	});
var _user$project$App$Search = F2(
	function (a, b) {
		return {query: a, status: b};
	});
var _user$project$App$Store = F4(
	function (a, b, c, d) {
		return {books: a, name: b, place: c, url: d};
	});
var _user$project$App$Book = F4(
	function (a, b, c, d) {
		return {offers: a, author: b, title: c, searchIndex: d};
	});
var _user$project$App$Offer = F2(
	function (a, b) {
		return {price: a, url: b};
	});
var _user$project$App$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$App$Waiting = {ctor: 'Waiting'};
var _user$project$App$initialSearch = A2(_user$project$App$Search, '', _user$project$App$Waiting);
var _user$project$App$Found = F2(
	function (a, b) {
		return {ctor: 'Found', _0: a, _1: b};
	});
var _user$project$App$Searching = function (a) {
	return {ctor: 'Searching', _0: a};
};
var _user$project$App$SelectOffer = F4(
	function (a, b, c, d) {
		return {ctor: 'SelectOffer', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$App$keyedViewOffer = F3(
	function (store, book, o) {
		return {
			ctor: '_Tuple2',
			_0: o.url,
			_1: A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$title(o.price)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A4(_user$project$App$SelectOffer, true, store, o, book))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('+')
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href(o.url),
							...
							[
								...
								A2(
									...
									_elm_lang$core$List$head(
										A2(_elm_lang$core$String$split, ',', o.price))))
							]))
					]))
		};
	});
var _user$project$App$keyedViewBook = F2(
	function (store, book) {
		return {
			ctor: '_Tuple2',
			_0: A2(
				_elm_lang$core$Basics_ops['++'],
				book.title,
				A2(_elm_lang$core$Basics_ops['++'], ', ', book.author)),
			_1: A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							's',
							_elm_lang$core$Basics$toString(book.searchIndex)))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(book.title)
									])),
								_elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], ', ', book.author))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('price')
							]),
						A2(
							_elm_lang$core$List$map,
							A2(_user$project$App$keyedViewOffer, store, book),
							book.offers))
					]))
		};
	});
var _user$project$App$keyedViewStore = function (store) {
	return {
		ctor: '_Tuple2',
		_0: store.url,
		_1: A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href(store.url),
							_elm_lang$html$Html_Attributes$target('_blank')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$html$Html$text(', '),
					_elm_lang$html$Html$text(store.place),
					A3(
					_elm_lang$html$Html_Keyed$node,
					'table',
					_elm_lang$core$Native_List.fromArray(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$App$keyedViewBook(store),
						store.books))
				]))
	};
};
var _user$project$App$viewResults = function (allResults) {
	var byBookCount = F2(
		function (a, b) {
			return A2(
				_elm_lang$core$Basics$compare,
				_elm_lang$core$List$length(a.books),
				_elm_lang$core$List$length(b.books));
		});
	var aggStores = F3(
		function (key, store, acc) {
			return A3(
				_elm_lang$core$Dict$update,
				key,
				function (maybeStore) {
	...
	var aggResults = F2(
		function (res, acc) {
			return A3(_elm_lang$core$Dict$foldl, aggStores, acc, res);
		});
	var stores = A3(_elm_lang$core$Array$foldl, aggResults, _elm_lang$core$Dict$empty, allResults);
	var sortedStores = _elm_lang$core$List$reverse(
		A2(
			_elm_lang$core$List$sortWith,
			byBookCount,
			_elm_lang$core$Dict$values(stores)));
	return A2(
	...
	function (_p8, _p7) {
		...
		return A2(
			...
			_elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(bookRows),
...
var _user$project$App$viewSelected = function (selected) {
	return A2(
		_elm_lang$html$Html_Keyed$ul,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Dict$toList(
			A2(
				_elm_lang$core$Dict$map,
				_elm_lang$html$Html_Lazy$lazy2(_user$project$App$viewSelectedStore),
				selected)));
};
var _user$project$App$FetchFail = F2(
	function (a, b) {
		return {ctor: 'FetchFail', _0: a, _1: b};
	});
var _user$project$App$FetchSucceed = F3(
	function (a, b, c) {
		return {ctor: 'FetchSucceed', _0: a, _1: b, _2: c};
	});
var _user$project$App$fetchBooks = F3(
	function (apiURL, i, query) {
		var decodeOffer = A3(
			_elm_lang$core$Json_Decode$object2,
			_user$project$App$Offer,
		...
		var decodeBook = A5(
			...
			A2(
				...
				'offers',
				_elm_lang$core$Json_Decode$list(decodeOffer)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'author', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string),
			_elm_lang$core$Json_Decode$succeed(i));
		var decodeStore = A5(
			_elm_lang$core$Json_Decode$object4,
			_user$project$App$Store,
			A2(
				_elm_lang$core$Json_Decode_ops[':='],
				'books',
				_elm_lang$core$Json_Decode$list(decodeBook)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'place', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'url', _elm_lang$core$Json_Decode$string));
		var decodeResp = _elm_lang$core$Json_Decode$dict(decodeStore);
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			apiURL,
			A2(_elm_lang$core$Basics_ops['++'], '/search?q=', query));
		return (!_elm_lang$core$Native_Utils.eq(query, '')) ? A3(
			_elm_lang$core$Task$perform,
			_user$project$App$FetchFail(i),
			A2(_user$project$App$FetchSucceed, i, query),
			A2(_evancz$elm_http$Http$get, decodeResp, url)) : _elm_lang$core$Platform_Cmd$none;
	});
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p14.ctor) {
			...
			case 'SearchThis':
				...
				var u = function (s) {
					return _elm_lang$core$Native_Utils.update(
						s,
						{
							status: _elm_lang$core$Native_Utils.eq(s.query, '') ? _user$project$App$Waiting : _user$project$App$Searching(s.query)
						});
				};
			...
			case 'AddBox':
				var searches = A2(_elm_lang$core$Array$push, _user$project$App$initialSearch, model.searches);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$App$updateURL(searches)
						]));
			case 'FetchFail':
				var u = function (s) {
					return _elm_lang$core$Native_Utils.update(
...
var _user$project$App$searchesFromURL = F2(
	function (l, model) {
		...
		var newsearches = A2(
			...
			queries);
		var changedsearches = A2(
			_elm_community$array_extra$Array_Extra$filterMap,
		...
		var filledsearches = A2(
			...
			A2(
				_elm_lang$core$Array$initialize,
				4 - _elm_lang$core$Array$length(newsearches),
				_elm_lang$core$Basics$always(_user$project$App$initialSearch)));
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
				model,
				{searches: filledsearches}),
			tasks);
	});
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					':',
					_elm_lang$core$Basics$toString(port_)))));
	var initialModel = A3(_user$project$App$Model, _elm_lang$core$Array$empty, _elm_lang$core$Dict$empty, apiURL);
	return A2(_user$project$App$searchesFromURL, l, initialModel);
};
var _user$project$App$AddBox = {ctor: 'AddBox'};
var _user$project$App$SearchThis = function (a) {
	return {ctor: 'SearchThis', _0: a};
};
var _user$project$App$UpdateBox = function (a) {
	return {ctor: 'UpdateBox', _0: a};
};
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Attributes$value(search.query),
							_elm_lang$html$Html_Events$onBlur(
							_user$project$App$SearchThis(i)),
							_elm_lang$html$Html_Events$onInput(
							function (v) {
								return _user$project$App$UpdateBox(
									{ctor: '_Tuple2', _0: i, _1: v});
							})
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$href('styles.css')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('busca múltipla na estante virtual')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id('left')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('procure por livro ou autor, ou uma mistura dos dois:'),
										A2(
										_elm_lang$html$Html$div,
										_elm_lang$core$Native_List.fromArray(
											[]),
										_elm_lang$core$Array$toList(
											A2(
												_elm_lang$core$Array$indexedMap,
												_elm_lang$html$Html_Lazy$lazy2(_user$project$App$viewSearchBox),
												model.searches))),
										A2(
										_elm_lang$html$Html$button,
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Events$onClick(_user$project$App$AddBox)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('mais um campo de busca')
											]))
									])),
								A2(
								_elm_lang$html$Html$div,
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_elm_lang$html$Html_Lazy$lazy, _user$project$App$viewSelected, model.selected)
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id('results')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$html$Html_Lazy$lazy, _user$project$App$viewResults, results)
							]))
					]))
			]));
};
